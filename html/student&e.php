          ...
          <div class="content-wrapper">
            ...
            <div class="container">
              ...
              <form class="row g-3 mb-4" method="POST" action="">
                <div class="col-md-3">
                  <input class="form-control" type="search" name="transaction_id" placeholder="Transaction ID" aria-label="Search">
                </div>
                <div class="col-md-3">
                  <input class="form-control" type="search" name="item_name" placeholder="Item Name" aria-label="Search">
                </div>
                <div class="col-md-2">
                  <input class="form-control" type="search" name="quantity" placeholder="Quantity" aria-label="Search">
                </div>
                <div class="col-md-2">
                  <input class="form-control" type="date" name="borrow_date" placeholder="Borrow Date" aria-label="Search">
                </div>
                <div class="col-md-2">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                  // Fetch items from database with pending or cancelled status for the logged-in user
                  $transaction_id = isset($_POST['transaction_id']) ? $_POST['transaction_id'] : '';
                  $item_name = isset($_POST['item_name']) ? $_POST['item_name'] : '';
                  $quantity = isset($_POST['quantity']) ? $_POST['quantity'] : '';
                  $borrow_date = isset($_POST['borrow_date']) ? $_POST['borrow_date'] : '';
                  ...
                  $sql = "SELECT t.transaction_id, i.name AS item_name, a.name AS account_name, t.quantity, t.borrow_date, t.borrow_time, t.status
                          ...
                          WHERE a.account_id = ? AND (t.status = 'Pending Request' OR t.status = 'Cancelled Request')";
                  ...
                  <tr>
                      ...
                      <td>
                          <form id="confirmForm<?php echo $row['transaction_id']; ?>" action="student_cancel.php" method="post" onsubmit="return confirmRequest(<?php echo $row['transaction_id']; ?>)">
                              <input type="hidden" name="transaction_id" value="<?php echo $row['transaction_id']; ?>">
                              <input type="hidden" name="status" value="Cancelled Request">
                              <?php if ($row['status'] !== 'Cancelled Request') { ?>
                              <button type="submit" class="btn btn-primary">Cancel Request</button>
                              <?php } else { ?>
                              <button type="button" class="btn btn-primary" disabled>Request Cancelled</button>
                              <?php } ?>
                          </form>
                      </td>
                  </tr>
