                    ...
                    <div class="container">
                        ...
                        <table class="table table-bordered">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-white">Action</th> <!-- New column for the delete button -->
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                $sql = "SELECT t.transaction_id, i.name AS item_name, a.name AS account_name, t.quantity, t.borrow_date, t.borrow_time, t.status
                                        ...
                                        WHERE a.account_id = ? AND t.status = 'returned'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form id="confirmForm<?php echo $row['transaction_id']; ?>" action="delete_transaction.php" method="post" onsubmit="return confirmRequest(<?php echo $row['transaction_id']; ?>)">
                                ...
                                ?>
                                    <tr>
                                        <td colspan="8">No returned items found</td>
                                    </tr>
                                <?php
                                }
                        ...
                        <script>
                            function confirmRequest(transactionId) {
                                Swal.fire({
                                    title: 'Are you sure?',
                                    text: "You are about to delete the request!",
                                    icon: 'warning',
