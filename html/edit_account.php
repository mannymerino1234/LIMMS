...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update the account in the database with the hashed password
    $updateSql = "UPDATE ACCOUNTS SET id_number='$newIdNumber', name='$newName', password='$hashedPassword', type='$newType' WHERE account_id = $accountId";
            ...
            <div class="container mt-5">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h2 class="text-center text-white">EDIT ACCOUNT</h2>
                    </div>
                    <div class="card-body">
                        <form method="post" action="">
                            <div class="form-group">
                                <label for="id_number">ID Number</label>
                                <input type="text" id="id_number" name="id_number" class="form-control" value="<?php echo $idNumber; ?>">
                            </div>
                            <div class="form-group">
