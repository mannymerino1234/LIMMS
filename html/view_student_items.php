                ...
                <div class="content-wrapper">
                    <div class="container">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                // Fetch items from the database with status "Confirmed Request"
                                ...
                                $sql = "SELECT t.transaction_id, i.name AS item_name, a.id_number AS id_number, t.quantity, t.status
                                        FROM transaction t
                                        INNER JOIN items i ON t.item_id = i.item_id
                                        INNER JOIN accounts a ON t.account_id = a.account_id
                                        WHERE a.account_id = ? AND t.status = 'Confirmed Request'";
