...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Retrieve category ID and new category name from form submission
    $category_id = $_POST['category_id'];
    $new_category_name = $_POST['category_name'];

    // Update category name in the database
    $sql = "UPDATE items_category SET category_name='$new_category_name' WHERE category_id=$category_id";
...
// Fetch category details from the database based on ID
$row = null;
if (isset($_GET['id'])) {
    $category_id = $_GET['id'];
    $sql = "SELECT * FROM items_category WHERE category_id=$category_id";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            <input type="hidden" name="category_id" value="<?php echo isset($row['category_id']) ? $row['category_id'] : ''; ?>">
                            <div class="form-group">
                                <label for="category_name">Category Name</label>
                                <input type="text" id="category_name" name="category_name" class="form-control" value="<?php echo isset($row['category_name']) ? $row['category_name'] : ''; ?>">
                            </div>
