                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php
                                // Fetch items from the database with status "returned" and search functionality
                                ...
                                $sql = "SELECT t.transaction_id, i.name AS item_name, a.name AS account_name, t.quantity, t.borrow_date, t.borrow_time, t.return_date, t.status
                                        FROM transaction t
                                ...
                                if ($stmt) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="9">No confirmed requests</td>
                                        </tr>
                                        <?php
                                    }
